...
static void camd33_send_dcw(__attribute__((unused)) struct s_client *client, ECM_REQUEST *er)
{
  uchar mbuf[1024];
  mbuf[0]=2;
...
static void * camd33_server(__attribute__((unused)) struct s_client * client, uchar *mbuf, int32_t n)
{
	switch(mbuf[0]) {
		case 2:
...
static void camd33_server_init(__attribute__((unused)) struct s_client * client) {
	uchar camdbug[256];
